/*
	...
	The code is customized for Los Atlantis OpenID provider selection
*/
...
openid = {
	 ...
	 * @return {Void}
	 */
	init : function(input_id, use_oidc_id) {
		providers = $.extend({}, providers_large, providers_small);
		var openid_btns = $('#openid_btns');
		this.input_id = input_id;
		this.use_oidc_id = use_oidc_id;
		$('#openid_choice').show();
		...
		if (box_id) {
		    console.log("Cookie read " + box_id);
	...
	signin : function(box_id, onload) {
		...
		if (provider['url']) {
		    ...
		    console.log("Provider does not have a url");
		}
	...
	submit : function() {
		...
		if (url != null && url != undefined && url.indexOf("javascript:") == 0) {
